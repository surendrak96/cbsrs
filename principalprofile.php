...
</script><link href='http://fonts.googleapis.com/css?family=Open+Sans:400italic,400,800,700,300' rel='stylesheet' type='text/css'>
															...
															if(pass.status==1)
																{
																	...
																	window.location = "principalprofile.php";
																}
		...
		<div class="row block01">
			<div class="col-full">
				<div class="wrap-col" align='center'>
					<h2 style="color:#2E80A5;">Principal Profile Page!</h2>
					<table border="0">
								<tr>
