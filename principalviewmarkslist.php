		...
		<div class="row block01">
			<div class="col-full">
				<div class="wrap-col">
					...
					<h2 style="color:#2E80A5;">View MarksList</h2>
			<form action='principalviewmarkslist.php' method='POST' enctype="multipart/form-data">				
				<table border="0">
						<tr>
								...
								$get_rec = mysql_fetch_array($success);
									...
									echo "
										...
										while($get_subject_marks = mysql_fetch_array($get_marks))
											{											
												echo "<td style='border:solid black 1px;padding:3px;' valign='middle'><p>Internal</p>".$get_subject_marks['internal']."</td>
												<td style='border:solid black 1px;padding:3px;' valign='middle'><p>External</p>".$get_subject_marks['external']."</td>";
												if($c==$count)
													{
